...
# Update RecordAlert string generation

record_alert_def = """func (e *Engine) RecordAlert(alert *livemap.Alert) {
	e.streamMu.Lock()
...
content = content.replace(record_alert_def, new_record_alert_def)
